...
C
C     This file is compiled separately (not through f2py) to avoid
C     f2py mis-declaring CHARACTER*4096 COMMON blocks (DOSNAM,
C     DSNAME, SOFDSN), which corrupts the shared memory layout.
C
